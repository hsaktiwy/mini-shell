...
#    Updated: 2023/05/06 19:06:41 by hsaktiwy         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

CC = cc
FLAGS = -Wall -Wextra -Werror
SRC = lexer.c parser_tools.c parser.c executer.c main.c free_token.c ast_tools.c lexer_tools.c redirection.c redirection_tools.c expanding_issue.c
BUILTINS = echo.c
INC = ft_lstdelete_index.c ft_lstadd_in_index.c ft_lstadd_front.c get_next_line_utils.c get_next_line.c ft_realloc.c ft_lstadd_back.c ft_lstnew.c ft_memset.c ft_split.c ft_strlen.c  ft_get_cmd.c ft_lstclear.c ft_lstsize.c ft_next_arg.c ft_strdup.c ft_substr.c ft_get_double_quote.c ft_get_simple_arg.c ft_get_single_quote.c ft_isalnum.c  ft_isalpha.c  ft_isdigit.c  ft_isprint.c  ft_iswhitespace.c ft_strjoin.c  ft_strncat.c
EXP = excep1.c

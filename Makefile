...
#    Updated: 2023/05/09 14:27:37 by aigounad         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBFT = ft_t_strdup.c ft_iswhitespace.c ft_strjoin.c  ft_strncat.c ft_isalnum.c  ft_isalpha.c  ft_isdigit.c  ft_isprint.c ft_strdup.c ft_substr.c ft_lstclear.c ft_lstsize.c ft_lstdelete_index.c ft_lstadd_in_index.c ft_lstadd_front.c  ft_strcmp.c  ft_realloc.c ft_lstadd_back.c ft_lstnew.c ft_memset.c ft_split.c ft_strlen.c
SRC = expand.c lexer.c parser_tools.c parser.c executer.c main.c free_token.c ast_tools.c lexer_tools.c redirection.c redirection_tools.c expanding_issue.c builtins/cd.c 
...
EXP = excep1.c
OBJ = $(ENV:%.c=obj/include/environement/%.o) $(SRC:%.c=obj/%.o) $(INC:%.c=obj/include/%.o) $(EXP:%.c=obj/include/exception/%.o) $(GET_NEXT_LINE:%.c=obj/include/get_next_line/%.o) $(LIBFT:%.c=obj/include/libft/%.o)
